...
urlpatterns = [
    ...
    path("assign-session-chair", views.AssignSession.as_view(), name='session-chairs'),
    path("session-chair-assignment", views.SessionChairAssignment.as_view(), name='session-chair-assignment'),
